...
- 다만 실제로 어떤 절전 상태(Light Sleep, Deep Sleep 등)까지 지원되는지는 **SoC의 Power Management 드라이버 구현 수준에 달려 있습니다** — ESP32-S3 Zephyr 포트는 계속 개발 중인 영역이라, 사용 중인 Zephyr 버전의 릴리스 노트에서 지원 현황을 확인하는 게 좋습니다
